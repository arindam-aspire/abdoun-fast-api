...
class Agency(Base):
    ...
    currency: Mapped[str] = mapped_column(String(3), nullable=False, server_default="JOD")
    measurement_unit: Mapped[str] = mapped_column(String(20), nullable=False, server_default="sqm")
